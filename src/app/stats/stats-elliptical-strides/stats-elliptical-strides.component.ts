...
@Component({
  selector: 'app-stats-elliptical-strides',
  templateUrl: './stats-elliptical-strides.component.html',
  styleUrls: ['./stats-elliptical-strides.component.css']
})
export class StatsEllipticalStridesComponent implements OnInit {
