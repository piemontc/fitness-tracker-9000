...
@Component({
  selector: 'app-stats-running-miles',
  templateUrl: './stats-running-miles.component.html',
  styleUrls: ['./stats-running-miles.component.css']
})
export class StatsRunningMilesComponent implements OnInit {
