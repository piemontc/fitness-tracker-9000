...
@Component({
  selector: 'app-stats-rower-mins',
  templateUrl: './stats-rower-mins.component.html',
  styleUrls: ['./stats-rower-mins.component.css']
})
export class StatsRowerMinsComponent implements OnInit {
